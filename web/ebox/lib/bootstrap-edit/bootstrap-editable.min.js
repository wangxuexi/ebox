(function(e) {
    ...
    t.prototype = {
        ...
        render: function() {
            ...
            //添加自定义点击事件
            $(".caneditok").click(function(){
            	EDIT_FLAG = true;
		    	console.log(EDIT_FLAG);
		    })
            $(".caneditno").click(function(){
            	EDIT_FLAG = false;
		    	console.log(EDIT_FLAG);
		    })
            e.when(this.input.render()).then(e.proxy(function() {
                ...
                if (this.input.error) this.error(this.input.error),
        ...
        showLoading: function() {
            var e, t;
            this.$form ? (e = this.$form.outerWidth(), t = this.$form.outerHeight(), e && this.$loading.width(e), t && this.$loading.height(t), this.$form.hide()) : (e = this.$loading.parent().width(), e && this.$loading.width(e)),
            this.$loading.show()
        },
        showForm: function(e) {
            this.$loading.hide(),
        ...
        error: function(t) {
            ...
            i;
            if (t === !1) n.removeClass(e.fn.editableform.errorGroupClass),
        ...
        save: function(t) {
            ...
            var n = typeof this.options.pk == "function" ? this.options.pk.call(this.options.scope) : this.options.pk,
            r = !!(typeof this.options.url == "function" || this.options.url && (this.options.send === "always" || this.options.send === "auto" && n !== null && n !== undefined)),
            i;
            if (r) return this.showLoading(),
            i = {
                name: this.options.name || "",
                value: t,
                pk: n
            },
            typeof this.options.params == "function" ? i = this.options.params.call(this.options.scope, i) : (this.options.params = e.fn.editableutils.tryParseJson(this.options.params, !0), e.extend(i, this.options.params)),
            typeof this.options.url == "function" ? this.options.url.call(this.options.scope, i) : e.ajax(e.extend({
...
function(e) {
    ...
    e.fn.editableutils = {
        ...
        itemsByValue: function(t, n, r) {
            ...
            return e.each(n,
            function(n, i) {
                if (i.children) o = o.concat(u.itemsByValue(t, i.children, r));
                else if (s) e.grep(t,
                function(e) {
        ...
        createInput: function(t) {
            var n, r, i, s = t.type;
            return s === "date" && (t.mode === "inline" ? e.fn.editabletypes.datefield ? s = "datefield": e.fn.editabletypes.dateuifield && (s = "dateuifield") : e.fn.editabletypes.date ? s = "date": e.fn.editabletypes.dateui && (s = "dateui"), s === "date" && !e.fn.editabletypes.date && (s = "combodate")),
            s === "datetime" && t.mode === "inline" && (s = "datetimefield"),
            s === "wysihtml5" && !e.fn.editabletypes[s] && (s = "textarea"),
            typeof e.fn.editabletypes[s] == "function" ? (n = e.fn.editabletypes[s], r = this.sliceObj(t, this.objectKeys(n.defaults)), i = new n(r), i) : (e.error("Unknown type: " + s), !1)
        },
...
function(e) {
    ...
    t.prototype = {
        ...
        init: function(n, r) {
            this.$element = e(n),
            this.options = e.extend({},
            e.fn.editableContainer.defaults, r),
            this.splitOptions(),
            ...
            this)),
            e(document).data("editable-handlers-attached") || (e(document).on("keyup.editable",
            function(t) {
                t.which === 27 && e(".editable-open").editableContainer("hide")
            }), e(document).on("click.editable",
            function(n) {
                var r = e(n.target),
                i,
        ...
        container: function() {
            ...
            return e = this.$element.data(this.containerName),
            e
        },
        call: function() {
        ...
        option: function(e, t) {
            this.options[e] = t,
            e in this.containerOptions ? (this.containerOptions[e] = t, this.setContainerOption(e, t)) : (this.formOptions[e] = t, this.$form && this.$form.editableform("option", e, t))
        },
...
function(e) {
    ...
    var t = function(t, n) {
        this.$element = e(t),
        this.options = e.extend({},
        e.fn.editable.defaults, n, e.fn.editableutils.getConfigData(this.$element)),
    ...
    t.prototype = {
        ...
        init: function() {
            ...
            this.options.value === undefined || this.options.value === null ? (this.value = this.input.html2value(e.trim(this.$element.html())), t = !0) : (this.options.value = e.fn.editableutils.tryParseJson(this.options.value, !0), typeof this.options.value == "string" ? this.value = this.input.str2value(this.options.value) : this.value = this.options.value),
            this.$element.addClass("editable"),
            this.input.type === "textarea" && this.$element.addClass("editable-pre-wrapped"),
            this.options.toggle !== "manual" ? (this.$element.addClass("editable-click"), this.$element.on(this.options.toggle + ".editable", e.proxy(function(e) {
        ...
        handleEmpty: function(t) {
            if (this.options.display === !1) return;
            t !== undefined ? this.isEmpty = t: e.trim(this.$element.html()) === "" ? this.isEmpty = !0 : e.trim(this.$element.text()) !== "" ? this.isEmpty = !1 : this.isEmpty = !this.$element.height() || !this.$element.width(),
            this.options.disabled ? this.isEmpty && (this.$element.empty(), this.options.emptyclass && this.$element.removeClass(this.options.emptyclass)) : this.isEmpty ? (this.$element.html(this.options.emptytext), this.options.emptyclass && this.$element.addClass(this.options.emptyclass)) : this.options.emptyclass && this.$element.removeClass(this.options.emptyclass)
        },
        show: function(t) {
        ...
        destroy: function() {
            ...
            this.input.destroy(),
            this.options.toggle !== "manual" && (this.$element.removeClass("editable-click"), this.$element.off(this.options.toggle + ".editable")),
    ...
    e.fn.editable = function(n) {
        ...
        case "submit":
            ...
            })) : typeof o.error == "function" && o.error.call(u, a),
            this
        }
        return this.each(function() {
            var r = e(this),
...
function(e) {
    ...
    e.extend(t.prototype, {
        ...
        value2html: function(t, n, r, i) {
            ...
            return t === null ? o.call(this) : this.onSourceReady(o,
            function() {
                s.resolve()
            }),
            s.promise()
        ...
        onSourceReady: function(t, n) {
            ...
            if (typeof r == "string") {
                ...
                e.ajax({
                    ...
                    success: e.proxy(function(r) {
                        ...
                        e.isArray(this.sourceData) ? (o && (o.sourceData = this.sourceData, e.each(o.callbacks,
                        function() {
                            this.call()
                        })), this.doPrepend(), t.call(this)) : (n.call(this), o && e.each(o.err_callbacks,
                        function() {
                            this.call()
                        }))
                    },
                    ...
                    error: e.proxy(function() {
                        n.call(this),
                        o && (o.loading = !1, e.each(o.err_callbacks,
                        function() {
                            this.call()
                        }))
                    },
            ...
            } else this.sourceData = this.makeArray(r),
            e.isArray(this.sourceData) ? (this.doPrepend(), t.call(this)) : n.call(this)
        },
        doPrepend: function() {
        ...
        makeArray: function(t) {
            ...
            if (e.isArray(t)) {
                ...
                for (var u = 0; u < t.length; u++) s = t[u],
                typeof s == "object" ? (n = 0, e.each(s, o), n === 1 ? i.push(r) : n > 1 && (s.children && (s.children = this.makeArray(s.children)), i.push(s))) : i.push({
                    value: s,
                    text: s
                })
            } else e.each(t,
...
function(e) {
    ...
    e.extend(t.prototype, {
        renderList: function() {
            ...
            var t = function(n, r) {
                var i;
                if (e.isArray(r)) for (var s = 0; s < r.length; s++) i = {},
                r[s].children ? (i.label = r[s].text, n.append(t(e("<optgroup>", i), r[s].children))) : (i.value = r[s].value, r[s].disabled && (i.disabled = !0), n.append(e("<option>", i).text(r[s].text)));
                return n
            };
    ...
    t.defaults = e.extend({},
    e.fn.editabletypes.list.defaults, {
        tpl: "<select></select>"
    }),
...
function(e) {
    ...
    e.extend(t.prototype, {
        ...
        str2value: function(t) {
            var n, r = null;
            return typeof t == "string" && t.length ? (n = new RegExp("\\s*" + e.trim(this.options.separator) + "\\s*"), r = t.split(n)) : e.isArray(t) ? r = t: r = [t],
            r
        },
...
function(e) {
    ...
    t.defaults = e.extend({},
    e.fn.editabletypes.text.defaults, {
...
function(e) {
    ...
    t.defaults = e.extend({},
    e.fn.editabletypes.number.defaults, {
...
function(e) {
    ...
    var t = function(n) {
        ...
        if (!n.select2.tags && n.source) {
            ...
            typeof r == "string" ? (n.select2.ajax = n.select2.ajax || {},
        ...
        this.options.select2 = e.extend({},
        t.defaults.select2, n.select2),
    ...
    e.extend(t.prototype, {
        ...
        value2html: function(t, n) {
            var r = "",
            i, s = this;
            this.options.select2.tags ? i = t: this.sourceData && (i = e.fn.editableutils.itemsByValue(t, this.sourceData, this.idFunc)),
            e.isArray(i) ? (r = [], e.each(i,
            function(e, t) {
                r.push(t && typeof t == "object" ? s.formatSelection(t) : t)
            })) : i && (r = s.formatSelection(i)),
            r = e.isArray(r) ? r.join(this.options.viewseparator) : r,
            e(n).text(r)
        },
        html2value: function(e) {
        ...
        value2input: function(t) {
            ...
            if (this.isRemote && !this.isMultiple && !this.options.select2.initSelection) {
                ...
                r = this.options.select2.formatSelection;
                if (!n && !r) {
                    var i = {
                        id: t,
...
function(e) {
    var t = function(t, n) {
        ...
        this.options = e.extend({},
        e.fn.combodate.defaults, n, this.$element.data()),
        this.init()
    };
    t.prototype = {
        constructor: t,
        ...
        fillDay: function() {
            ...
            t,
            n,
            r = this.options.template.indexOf("DD") !== -1;
            for (n = 1; n <= 31; n++) t = r ? this.leadZero(n) : n,
            e.push([n, t]);
            return e
        },
        fillMonth: function() {
            ...
            t,
            n,
            r = this.options.template.indexOf("MMMM") !== -1,
            i = this.options.template.indexOf("MMM") !== -1,
            s = this.options.template.indexOf("MM") !== -1;
            for (n = 0; n <= 11; n++) r ? t = moment().date(1).month(n).format("MMMM") : i ? t = moment().date(1).month(n).format("MMM") : s ? t = this.leadZero(n + 1) : t = n + 1,
            e.push([n, t]);
            return e
        },
        fillYear: function() {
            ...
            t,
            n,
            r = this.options.template.indexOf("YYYY") !== -1;
            for (n = this.options.maxYear; n >= this.options.minYear; n--) t = r ? n: (n + "").substring(2),
            e[this.options.yearDescending ? "push": "unshift"]([n, t]);
            return e = this.initItems("y").concat(e),
            e
        },
        fillHour: function() {
        ...
        fillMinute: function() {
            ...
            t,
            n,
            r = this.options.template.indexOf("mm") !== -1;
        ...
        fillSecond: function() {
            ...
            t,
            n,
            r = this.options.template.indexOf("ss") !== -1;
            for (n = 0; n <= 59; n += this.options.secondStep) t = r ? this.leadZero(n) : n,
            e.push([n, t]);
            return e
        },
        fillAmpm: function() {
        ...
        setValue: function(t) {
            ...
            r = this,
            i = {};
            n.isValid() && (e.each(this.map,
            function(e, t) {
                if (e === "ampm") return;
                i[e] = n[t[1]]()
            }), this.$ampm && (i.hour >= 12 ? (i.ampm = "pm", i.hour > 12 && (i.hour -= 12)) : (i.ampm = "am", i.hour === 0 && (i.hour = 12))), e.each(i,
            function(e, t) {
    ...
    e.fn.combodate = function(n) {
        ...
        return i.shift(),
        n === "getValue" && this.length && (r = this.eq(0).data("combodate")) ? r.getValue.apply(r, i) : this.each(function() {
            var r = e(this),
            s = r.data("combodate"),
            o = typeof n == "object" && n;
...
function(e) {
    ...
    var t = function(n) {
        ...
        this.options.combodate = e.extend({},
        t.defaults.combodate, n.combodate, {
...
function(e) {
    ...
    e.fn.editableform.buttons = '<button type="submit" class="btn btn-primary editable-submit caneditok"><i class="icon-ok icon-white"></i></button><button type="button" class="btn editable-cancel caneditno"><i class="icon-remove"></i></button>',
    e.fn.editableform.errorGroupClass = "error",
...
function(e) {
    ...
    e.extend(e.fn.editableContainer.Popup.prototype, {
        ...
        initContainer: function() {
            ...
            var t;
            this.$element.data("template") && (t = this.$element.data("template"), this.$element.removeData("template")),
            this.call(this.containerOptions),
        ...
        setPosition: function() { (function() {
                ...
                n = /in/.test(o),
                t.removeClass("top right bottom left").css({
                    top: 0,
                    left: 0,
                    display: "block"
                }),
...
function(e) {
    ...
    function s(t, n) {
        ...
        for (var u in r) n.test(u) && (s = u.replace(o,
        function(e, t) {
    ...
    r.prototype = {
        ...
        _process_options: function(t) {
            ...
            this._o),
            r = n.language;
            c[r] || (r = r.split("-")[0], c[r] || (r = f.language)),
            n.language = r;
            switch (n.startView) {
            case 2:
            case "decade":
        ...
        _trigger: function(t, n) {
            var r = n || this.date,
            i = new Date(r.getTime() + r.getTimezoneOffset() * 6e4);
        ...
        getFormattedDate: function(e) {
            return e === undefined && (e = this.o.format),
            h.formatDate(this.date, e, this.o.language)
        },
        ...
        update: function() {
            ...
            var e, t = !1;
            arguments && arguments.length && (typeof arguments[0] == "string" || arguments[0] instanceof Date) ? (e = arguments[0], t = !0) : (e = this.isInput ? this.element.val() : this.element.data("date") || this.element.find("input").val(), delete this.element.data().date),
        ...
        fill: function() {
            ...
            r -= 1;
            for (var C = -1; C < 11; C++) m += '<span class="year' + (C == -1 ? " old": C == 10 ? " new": "") + (x == r ? " active": "") + (r < s || r > u ? " disabled": "") + '">' + r + "</span>",
            r += 1;
            N.html(m)
        },
        ...
        click: function(n) {
            ...
            case "td":
                if (r.is(".day") && !r.is(".disabled")) {
                    ...
                    r.is(".old") ? f === 0 ? (f = 11, l -= 1) : f -= 1 : r.is(".new") && (f == 11 ? (f = 0, l += 1) : f += 1),
        ...
        _setDate: function(e, t) {
            ...
            n && (n.change(), this.o.autoclose && (!t || t == "date") && this.hide())
        },
        ...
        keydown: function(e) {
            ...
            case 39:
                ...
                n = e.keyCode == 37 ? -1 : 1,
                e.ctrlKey ? (s = this.moveYear(this.date, n), o = this.moveYear(this.viewDate, n)) : e.shiftKey ? (s = this.moveMonth(this.date, n), o = this.moveMonth(this.viewDate, n)) : (s = new Date(this.date), s.setUTCDate(this.date.getUTCDate() + n), o = new Date(this.viewDate), o.setUTCDate(this.viewDate.getUTCDate() + n)),
                this.dateWithinRange(s) && (this.date = s, this.viewDate = o, this.setValue(), this.update(), e.preventDefault(), t = !0);
                break;
            case 38:
            case 40:
                if (!this.o.keyboardNavigation) break;
                n = e.keyCode == 38 ? -1 : 1,
                e.ctrlKey ? (s = this.moveYear(this.date, n), o = this.moveYear(this.viewDate, n)) : e.shiftKey ? (s = this.moveMonth(this.date, n), o = this.moveMonth(this.viewDate, n)) : (s = new Date(this.date), s.setUTCDate(this.date.getUTCDate() + n * 7), o = new Date(this.viewDate), o.setUTCDate(this.viewDate.getUTCDate() + n * 7)),
                this.dateWithinRange(s) && (this.date = s, this.viewDate = o, this.setValue(), this.update(), e.preventDefault(), t = !0);
                break;
            case 13:
                this.hide(),
    ...
    h = {
        ...
        parseDate: function(n, i, s) {
            ...
            var u = n && n.match(this.nonpunctuation) || [],
            n = new Date,
            p = {},
    ...
    e.fn.datepicker.noConflict = function() {
        return e.fn.datepicker = u,
        this
    },
    e(document).on("focus.datepicker.data-api click.datepicker.data-api", '[data-provide="datepicker"]',
    function(t) {
        var n = e(this);
...
function(e) {
    ...
    e.extend(t.prototype, {
        initPicker: function(t, n) {
            ...
            this.options.datepicker = e.extend({},
            n.datepicker, t.datepicker, {
        ...
        parseDate: function(e, t) {
            var n = null,
            r;
            return e && (n = this.dpg.parseDate(e, t, this.options.datepicker.language), typeof e == "string" && (r = this.dpg.formatDate(n, t, this.options.datepicker.language), e !== r && (n = null))),
            n
        }
    }),
    t.defaults = e.extend({},
...
function(e) {
    ...
    t.defaults = e.extend({},
    e.fn.editabletypes.date.defaults, {
...
function(e) {
    ...
    e.extend(t.prototype, {
        initPicker: function(t, n) {
            ...
            this.options.datetimepicker = e.extend({},
            n.datetimepicker, t.datetimepicker, {
                format: this.options.viewformat
            }),
        ...
        parseDate: function(e, t) {
            var n = null,
            r;
            return e && (n = this.dpg.parseDate(e, t, this.options.datetimepicker.language, this.options.formatType), typeof e == "string" && (r = this.dpg.formatDate(n, t, this.options.datetimepicker.language, this.options.formatType), e !== r && (n = null))),
            n
        }
    }),
    t.defaults = e.extend({},
...
function(e) {
    ...
    t.defaults = e.extend({},
    e.fn.editabletypes.datetime.defaults, {
        tpl: '<div class="input-append date"><input type="text"/><span class="add-on"><i class="icon-th"></i></span></div>',
        inputclass: "input-medium",
        datetimepicker: {
            todayHighlight: !1,
...
function(e) {
    "use strict";
    var t = function(n) {
        this.init("typeahead", n, t.defaults),
        this.options.typeahead = e.extend({},
        t.defaults.typeahead, {
    ...
    e.extend(t.prototype, {
        renderList: function() {
            ...
            t.render = e.proxy(this.typeaheadRender, t),
            t.select = e.proxy(this.typeaheadSelect, t),
            t.move = e.proxy(this.typeaheadMove, t),
            this.renderClear(),
            this.setClass(),
            this.setAttr("placeholder")
        },
        ...
        clear: function() {
            e.fn.editabletypes.text.prototype.clear.call(this),
        ...
        sorter: function(e) {
            ...
            i,
            s;
            while (i = e.shift()) s = i.text,
            s.toLowerCase().indexOf(this.query.toLowerCase()) ? ~s.indexOf(this.query) ? n.push(i) : r.push(i) : t.push(i);
            return t.concat(n, r)
        },
        ...
        updater: function(e) {
            return this.$element.data("value", e.value),
            e.text
        },
        typeaheadRender: function(t) {
            var n = this;
            return t = e(t).map(function(t, r) {
                return t = e(n.options.item).data("item", r),
                t.find("a").html(n.highlighter(r)),
                t[0]
            }),
            this.options.autoSelect && t.first().addClass("active"),
            this.$menu.html(t),
            this
        },
        typeaheadSelect: function() {
            var e = this.$menu.find(".active").data("item");
            return (this.options.autoSelect || e) && this.$element.val(this.updater(e)).change(),
            this.hide()
        },
